...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'primary', size = 'md', loading, iconLeft, iconRight, children, className, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      secondary: 'bg-gray-100 text-gray-800 hover:bg-gray-200 focus:ring-gray-300 dark:bg-gray-850 dark:text-gray-100 dark:hover:bg-gray-800 dark:focus:ring-gray-700',
      outline: 'border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 focus:ring-gray-300 dark:border-gray-800 dark:text-gray-200 dark:bg-gray-950 dark:hover:bg-gray-900 dark:focus:ring-gray-700',
      ghost: 'text-gray-600 hover:bg-gray-100 focus:ring-gray-200 dark:text-gray-300 dark:hover:bg-gray-900 dark:focus:ring-gray-700',
